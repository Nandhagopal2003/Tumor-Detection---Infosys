...
model_path = r'D:\Nandhagopal\Infosys Intern\iris_tumor_detection-main\iris_tumor_detection-main\iris_tumor_detection-main\iris_tumor_detection\detection\iris_tumor_model_vgg16.keras'  # Update path if necessary
